...
if ( $dfAttackers > 0){
?>
	<?= $self->translate("A total of ") . $self->colorNumber($self->data->totalDebrisAttackers, '#ff00ff') . $self->translate(" units debris has been recycled by the attackers.") ?>
	
<?php 
}
if ( $dfDefenders > 0){
?>
	<?= $self->translate("A total of ") . $self->colorNumber($self->data->totalDebrisDefenders, '#ff00ff') . $self->translate(" units debris has been recycled by the defenders.") ?>
