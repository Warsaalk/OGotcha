...
$lang["copy-paste-raids-p1"] = "Het kopi&euml;ren van je na-raids werkt hetzelfde als het kopi&euml;ren van je gevechtsrapport. Hier heb je ook de mogelijkheid om in overzichts bericht van je gevechtsrapport alleen de lijn van buit te kopi&euml;ren zodat je niet het hele gevechtsrapport moet gebruiken.";
$lang["copy-paste-raids-p2"] = "De raids kan je plakken in het tekstveld in het Na-raids blok, indien je meerdere na-raids hebt kan je deze gewoon onder elkaar plaatsen.";
$lang["Add your harvest reports"] = "Voeg de puinrapporten toe";
$lang["copy-paste-harvest"] = "Voor het kopi&euml;ren van puinrapporten open je het rapport in je berichten en selecteer je de inhoud van het bericht (het rapport). Als je het rapport hebt gekopieerd plak je deze in het puinrapport tekstveld in de juiste kolom, indien het een puinrapport van de aanvaller(s) is in de aanvaller(s) kolom en anders in de verdediger(s) kolom. Wanneer je meerdere puinrapporten hebt plak je deze onder elkaar in het juiste tekstveld.";
$lang["Enter your deuterium costs"] = "Voer de deuterium kosten in";
$lang["copy-paste-deuterium-p1"] = "Het invoeren van je deuterium (brandstof) kosten moet je manueel doen in dit formaat: \"[getal] Deuterium\". Voorbeeld: Als je vloot 3 miljoen deuterium nodig had voor de vlucht geef je dit in, \"3.000.000 Deuterium\", let er op dat je de 'punten' in je getal niet vergeet.";
$lang["copy-paste-deuterium-p2"] = "Als er meerdere vloten waren, je vloot in delen het gestuurd of de kosten van je Recyclers wilt ingeven kan je deze onder elkaar plaatsen in de juiste kolom.";